...
const PostCard = ({post}) => {
  return (
    <div className=" shadow-lg bg-zinc-800	 p-0 lg:p-8 pb-12 mb-8">

    <div className="relative overflow-hidden shadow-md pb-80 mb-6">
      <img src={post.featuredImage.url} alt="" className="object-top absolute h-80 w-full object-cover  shadow-lg " />
    </div>

    <h1 className="transition duration-700 text-center mb-8 cursor-pointer hover:text-purple-700 text-3xl font-semibold text-white">
